      ...
      <div className="container ">
        <div className="row ">
          ...
          <div className=" col-md-6 mt-5 ">
            <img id='educare'
              className="img-fluid"
              style={{ height: '50svh',width:'80%', marginLeft: '50px', marginTop: '55px',borderRadius:'15px' }}
              src={EducareLogo} 
              alt="Logo"
            />
          </div>
       ...
       <center><h1 style={{color: 'blue', fontFamily: 'calibri', fontSize: '35px',}}>TESTIMONIALS</h1></center> 
        ...
        <div className='row my-4 g-3' >
          <div className='col-md-3'>
            <div className="card" style={{height:'100%'}}>
              ...
              <div className="card-body">
                ...
                <img
              className="img-fluid"
              style={{ height: '14svh',width:'40%',borderRadius:'20px',paddingBottom:'10px' }}
              src={madhav_avtar} 
              alt="Logo"
            />
                </center>
          ...
          <div className='col-md-3'>
           ...
           <img
              className="img-fluid"
              style={{ height: '14svh',width:'40%', marginTop: '-2  px',borderRadius:'20px' }}
              src={vamsi_avtar} 
              alt="Logo"
            />
           </center>
          ...
          <div className='col-md-3'>
            <div className="card " style={{height:'100%'}}>
             ...
             <img
              className="img-fluid"
              style={{ height: '14svh',width:'40%',marginTop: '-5  px',borderRadius:'20px' }}
              src={hajee_avtar} 
              alt="Logo"
            />
             </center>
