    ...
    <div className="container-fluid bg-light mt-5">
      <div className="container-fluid bg-dark">
        ...
        <div className="row bg-dark g-3" id="bgimg2">
            <div className="fc col-lg-4 col-md-4 mt-5 ">
              <div className="card mt-5 p-5 " id='service_card' style={{ width: '23rem', textAlign: 'center' }}>
                <h2 style={{color: 'blue', fontFamily: 'calibri', fontSize: '35px'}}>FREE <br />CONSULTATION</h2>
            ...
            <div className="col-lg-4 col-md-4 mt-5">
              <div className="card mt-5 p-5 " id='service_card' style={{ width: '23rem', textAlign: 'center' }}>
                <h2 style={{color: 'blue', fontFamily: 'calibri', fontSize: '35px'}}>ONLINE <br />COACHING</h2>
                <div className="card-body">
                  <p className="card-text mt-3" style={{fontSize:'15px'}}>
                    Use this area to describe one of <br /> your services.
                  </p>
            ...
            <div className="col-lg-4 col-md-4 mt-5">
              <div className="card mt-5 p-5 " id='service_card' style={{ width: '23rem', textAlign: 'center',height:'89%' }}>
                <h2 style={{color: 'blue', fontFamily: 'calibri', fontSize: '35px'}}>SELF IMPROVEMENT <br />WORKSHOP</h2>
                <div className="card-body">
            ...
            <button className="bg-primary mt-5" id="btn5" style={{ marginTop: '5%',width:'150px', height:'40px', borderRadius:'10px', border:'none',color:'white', marginBottom:'25px'  }}>
              More services
            </button>
          </div>
        </div>
      ...
      <div className="container mt-4">
        <div className="row">
          <h1 style={{marginTop: '3%' }}>
            <h1 style={{color: 'blue', fontFamily: 'calibri', fontSize: '38px',marginLeft:'26px'}} >Services!</h1  >
          </h1>
          <div className="col-lg-5 col-md-12 mt-3 ps-1" style={{marginLeft:'28px'}}>
          ...
          <div className="gif-1 col-lg-6  p-3">
            <div className="img-fluid">
              <img style={{ width: '100%',marginTop:'-85px',marginLeft:'55px'}} src={gif2} alt="" />
            </div>
          </div>
        </div>
        <div className="row">
