          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent" style={{ paddingLeft: '10%', fontSize: '20px' }}>
            <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{ marginLeft: '5%' }}>
              ...
              <div className="dropdown">
                <button className="btn dropdown-toggle" type="button" style={{ fontSize: '20px', marginLeft: '30px', outline:"none" }} id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                  Courses
                </button>
                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1" style={{ marginLeft: '30px' }}>
              ...
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" to='/services' style={{ marginLeft: '30px' }}>Services</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" to='/aboutus' style={{ marginLeft: '30px' }}>About Us</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" to='/contactus' style={{ marginLeft: '30px' }}>Contact Us</Link>
              </li>
            </ul>
